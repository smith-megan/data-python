...
colors=["purple", "red", "orange", "blue", "black"]
...
friends.insert(2, "Sarah")
print(friends)

# Problem 15
# Remove the last item in the array 
# (try to think about how you can do this dynamically, meaning, if the array contents were to change, 
